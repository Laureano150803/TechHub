...
public class ControllerAdvisor {
    ...
    public ResponseEntity<ErrorResponse> handleResourceAlreadyExist(ResourceAlreadyExist ex){
    ...
    public ResponseEntity<ErrorResponse> handleElementNotFound(ElementNotFound ex){
